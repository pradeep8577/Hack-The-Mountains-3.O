...
const UpdateDocs = () => {
  ...
  return (
    ...
    <div className="m-3 container shadow p-3 mb-5 bg-body">
      <br />
      ...
      <div className="p-5">
        <form method="GET">
          ...
          <input
            ...
            className="mx-2 col-3 form-control"
          />
          <br />
          <input
            type="submit"
          ...
          <form method="POST">
            ...
            <div className="row">
              ...
              <input
                ...
                className="mx-2 col-4 form-control"
                value={feedback}
        ...
        <input type="file" id="myFile" name="filename"></input>
            ...
            <div className="row">
              <input
                ...
                onClick={updateData}
              />
              <Link to="/aAbBcC" className="btn btn-outline-warning mx-4 mb-1 update">
                Back
              </Link>
